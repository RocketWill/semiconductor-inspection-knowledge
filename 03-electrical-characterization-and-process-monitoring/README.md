# Electrical Characterization and Process Monitoring

This section started from a fairly simple confusion: resistivity, sheet resistance, contact resistance, and diode series resistance appear in nearby problems, but they do not describe the same part of a structure. The notes begin with four-point-probe measurements, then move to TLM, diode parameter extraction, and a small process-monitor example.
...
3. [Diode Parameters and Process Monitoring](./03-diode-parameters-and-process-monitoring.md) — saturation current, ideality factor, series resistance, and a polysilicon resistance-drift example.
...
Once I stopped treating these resistances as interchangeable, the formulas became much easier to follow. The limits did too.
...
I have not carried out four-point-probe or TLM measurements, or operated electrical process-monitoring equipment in production. The project connections in these notes are limited to habits carried over from wafer-inspection software: keeping a value linked to its wafer context, measurement conditions, spatial position, history, and later verification.
